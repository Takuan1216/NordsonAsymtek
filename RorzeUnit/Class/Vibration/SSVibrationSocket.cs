...
{
    public class SSVibrationSocket
    {
        ...
        public SSVibrationSocket(string strIP, int nPort, int nBodyNO, string strUnitName, bool bSimulate, sServer Sever = null)
        {
            m_Sever = Sever;
            m_strIP = strIP;
            m_nPortNo = nPort;
        ...
        public void SendCommand(string strCommand, [CallerLineNumber] int lineNumber = 0, [CallerMemberName] string caller = null)
        {
            ...
            string strFrame = string.Format("o{0}.{1}{2}", m_strUnitName, strCommand.ToUpper(), (char)0x0D); //尾碼 \r\n = ascii[13][10] = CrL
        ...
        public void SendCommandVibration(string strCommand, [CallerLineNumber] int lineNumber = 0, [CallerMemberName] string caller = null)
        {
            //string strFrame = string.Format("{0}{1}{2}", strCommand, (char)0x0A, (char)0x0D); //尾碼 \r\n = ascii[13][10] = CrL  
            string strFrame = string.Format("o{0}.{1}{2}{3}", m_strUnitName, strCommand.ToUpper(), (char)0x0D, (char)0x0A); //尾碼 \r\n = ascii[13][10] = CrL
            WriteLog(string.Format("send : {0}", strFrame));
        ...
        public void SendContent(string strContent, [CallerLineNumber] int lineNumber = 0, [CallerMemberName] string caller = null)
        {
            //string strFrame = string.Format("{0}{1}{2}", strCommand, (char)0x0A, (char)0x0D); //尾碼 \r\n = ascii[13][10] = CrL  
            string strFrame = string.Format("{0}{1}{2}", strContent, (char)0x0D, (char)0x0A); //尾碼 \r\n = ascii[13][10] = CrL
            WriteLog(string.Format("send : {0}", strFrame));
