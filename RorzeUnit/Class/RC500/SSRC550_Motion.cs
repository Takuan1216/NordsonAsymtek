...
{
    public class SSRC550_Motion : SSRC5X0Parents_Motion
    {
        public SSRC550_Motion(string IP, int PortID, int nBodyNo, bool bDisable, bool bSimulate, sServer Sever = null)
        ...
        protected override void CreateMessage()
        {
            ...
            m_dicController[0x01] = "[01:Motor driver:The 1st Axis] ";
            m_dicController[0x02] = "[02:Motor driver:The 2nd Axis] ";
            m_dicController[0x03] = "[03:Motor driver:The 3rd Axis] ";
            m_dicController[0x04] = "[04:Motor driver:The 4th Axis] ";
            m_dicController[0x05] = "[05:Motor driver:The 5th Axis] ";
            m_dicController[0x06] = "[06:Motor driver:The 6th Axis] ";
            m_dicController[0x0F] = "[0F:Motor driver] ";
            ...
            m_dicController[0xE1] = "[E1:Group1] ";
            m_dicController[0xE2] = "[E2:Group2] ";
            m_dicController[0xE3] = "[E3:Group3] ";
            m_dicController[0xE4] = "[E4:Group4] ";
            m_dicController[0xE5] = "[E5:Group5] ";
            m_dicController[0xE6] = "[E6:Group6] ";
