...
namespace Wid110LibConstUser
{
    static partial class Wid110LibConst
    {
        ...
        public static int ecFileTooLong = 22;       // File is too long
        public static int ecFileRejected = 23;      // File was rejected
        public static int exInvalidConfiguration = 24; //ERROR_INVALID_CONFIGURATION
