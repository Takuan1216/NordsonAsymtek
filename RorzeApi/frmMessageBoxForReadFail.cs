...
namespace RorzeApi
{
    public partial class frmMessageBoxForReadFail : Form
    {
        private MessageBoxIcon _icon;

        private string m_strID = "ReadFail";

        public string GetID { get { return m_strID; } }


        public frmMessageBoxForReadFail(string message, string caption, MessageBoxButtons buttons, MessageBoxIcon icon,string strPicturePath)
        {
            InitializeComponent();
            try
            {
                ...
                this.Height = tableLayoutPanel1.Height + layoutButton2.Height + pictureBox1.Height + 60;

                //string strPath = "C:\\Users\\Ming\\Downloads\\9G20240301001_BWS_20240623_v1.000\\9G20240301001_BWS_20240623_v1.000\\RorzeApi\\bin\\Debug\\OCR_Image\\20240324 11_54_35 A2.bmp";
                if (System.IO.File.Exists(strPicturePath))
                {
                    Image img = Image.FromFile(strPicturePath);
        ...
        private void picIcon_Paint(object sender, PaintEventArgs e)
        {
            try
            {
                Rectangle r = new Rectangle(picIcon.Left, picIcon.Top, picIcon.Width, picIcon.Height);
                switch (_icon)
                {
                    ...
                    case MessageBoxIcon.Question:
                        e.Graphics.DrawIcon(SystemIcons.Question, r/*picIcon.Left, picIcon.Top*/);
                        break;
                    case MessageBoxIcon.Warning:
                        e.Graphics.DrawIcon(SystemIcons.Warning, r);
                        break;
                    default:
                        break;
                }
        ...
        private void frmMessageBoxForReadFail_FormClosed(object sender, FormClosedEventArgs e)
        {
            m_strID = textBox1.Text;
        }
    }
}
